 ...
 */
public class GiveBadgeCommonListExtractDAO extends UniBaseDao implements IExtractComponentDao<GiveBadgeCommonListExtract> {
    @Override
    public void doCommit(GiveBadgeCommonListExtract extract, Map parameters){
        //save print form
...
//        orderData.setGraduateDiplomaOrderNumber(extract.getParagraph().getOrder().getNumber());
    ...
    @Override
    public void doRollback(GiveBadgeCommonListExtract extract, Map parameters){
