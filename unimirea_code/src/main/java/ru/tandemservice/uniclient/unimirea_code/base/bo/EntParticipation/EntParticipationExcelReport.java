...
public class EntParticipationExcelReport
{
    public ByteArrayOutputStream genereteExcelReport()throws Exception {
        ...
        while (entityListIterator.hasNext()){
            ...
            Label title = new Label(2, currentRow, entPart.getUnit().getTitle());
            ...
            try
            {
                dateEnd = new Label(4, currentRow, entPart.getUnit().getDateEnd().toString());
            }catch (NullPointerException e){
                dateEnd = new Label(4, currentRow, "Неизвестно");
            }
