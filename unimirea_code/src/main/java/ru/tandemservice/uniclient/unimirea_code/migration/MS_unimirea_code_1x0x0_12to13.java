...
public class MS_unimirea_code_1x0x0_12to13 extends IndependentMigrationScript
{
    @Override
    ...
    public void run(DBTool tool) throws Exception
    {
		...
		// у сущности больше нет своей таблицы
		{
			...
			// удалить таблицу
			tool.dropTable("gvbdgwthusgnlstextrct_t", true /* - игнорировать ссылающиеся таблицы (в них удалятся foreign keys) */);
		...
		// у сущности больше нет своей таблицы
		{
			...
			// удалить таблицу
			tool.dropTable("givebadgecommonlistextract_t", true /* - игнорировать ссылающиеся таблицы (в них удалятся foreign keys) */);
